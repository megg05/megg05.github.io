...
- Improving simulation model fidelity for validating new controller design.
- Formulating a control problem and implementing a control scheme on a PX4 flight computer.
- Electrical system design (selection of components and wiring) for custom control of propellers and servos.
